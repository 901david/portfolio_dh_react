...
import { HeadShot, Tagline } from '../../components/Header/styled-components';
...
export const LandingBackground = styled.div<{ removeContentTriggered: boolean; landingViewedOnce?: boolean }>`
  width: 100vw;
  height: 100vh;
  position: absolute;
  top: 0;
...
export const IconWrapper = styled.div`
  > svg {
    color: white;
    font-size: 12rem;
    animation: ${arrowVibrate(0) as any} 1.2s infinite;
    cursor: pointer;
  }
