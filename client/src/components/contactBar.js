...
class ContactBar extends Component {
  render () {
    return (
      <div>
      <div className="col-xs-2 col-sm-2 col-md-1 col-lg-1" id="contactBar">

        <div className="col-xs-10 col-sm-8 col-md-12 col-lg-12 pull-left">
        ...
        <div className="col-xs-10 col-sm-8 col-md-12 col-lg-12 clear pull-left">
          ...
          <div className="col-xs-10 col-sm-8 col-md-12 col-lg-12">
          ...
          <div className="col-xs-10 col-sm-8 col-md-12 col-lg-12 pull-left">
            <img onClick={this.props.handleEmailOpen} style={{cursor:'pointer'}} className="img-responsive emailModal" src="./images/mail.png" alt="Email Me" />
              ...
              <div className="col-xs-12" id="contactBarTwo">
